...
<main>
    <section class="intro-section">
        <div class="row">
            ...
            <div class="col-sm-9">
                <p>Для того чтобы создать дисциплину введите новые значения поля и нажмите кнопку "Применить":</p>
                <form action="/creat-disciplines" method="post">
                    Название <input  type="text" placeholder="название" name="name" value="${name}" > <br>
<%--                    required--%>
